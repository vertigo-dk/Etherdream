...
//////////////////////////////////////////////////////////////////////////
typedef void(__stdcall* pEtherDreamGetIP)(const int* CardNum, char* buf, int max);
...
//////////////////////////////////////////////////////////////////////////
static pEtherDreamGetIP				EtherDreamGetIP(nullptr);
...
#ifdef _WIN32
	// Extract function
	EtherDreamGetIP = (pEtherDreamGetIP)GetProcAddress(EtherDreamDLL, "EtherDreamGetIP");
	if (!EtherDreamGetIP)
		return false;
...
std::string netherdream::GetIP(int inDacNum)
{
	char buffer[256];
	EtherDreamGetIP(&inDacNum, buffer, 256);
...
**/
int netherdream::GetStatus(int inDacNum)
{
	return EtherDreamGetStatus(&inDacNum);
}
